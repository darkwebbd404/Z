...
def xoakbbot(jwt_token, player_id):
    url = f"https://projects-fox-apis.vercel.app/remove_friend?token={jwt_token}&id={player_id}&key=projects_xxx_3ei93k_codex_xdfox"
...
def send_likes(uid):
    try:
        likes_api_response = requests.get(
            f"https://like-freefireobi.vercel.app/like?uid={uid}&server_name=vn&key=obibot1102"
        )
        
        message = ("""
[C][B][FF0000]‎━━━━━━━━━━━━
[FFFFFF]ID không hợp lệ. Vui lòng kiểm tra lại.
[FF0000]‎━━━━━━━━━━━━
""")
...
[C][B][11EAFD]‎━━━━━━━━━━━━
[C][B][FFB300]Tạo Bởi: [FFFFFF]Con Bò [00FF00]TranBaoDev!!
                """
            else:
                message = (
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if data['status'] == 'success':
                ...
                print("Failed to get token: Status not success")
        else:
            print(f"Failed to get token: HTTP status {response.status_code}")
...
‎━━━━━━━━━━━━
[808080][B][C]Tạo Bởi: [FFFFFF]Con Bò [00FF00]TranBaoDev!!
    """
        return msg_visit
    else:
...
[00FF00]/🗿help
[C][B][00FFFF]━━━━━━━━━━━━
[C][B][808080]Tạo Bởi: [FFFFFF]Con Bò [00FF00]TranBaoDev!!
""",uid
                            )
                        )
                else:
